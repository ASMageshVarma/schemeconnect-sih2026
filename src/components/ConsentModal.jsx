...
const CONSENT_CONTENT = {
  en: {
    badge: "Ministry of Social Justice & Empowerment • MoSJE • JanSetu Sovereign Core",
    title: "Terms, Privacy & Data Consent",
    subtitle: "JanSetu AI — Autonomous Sovereign Welfare Discovery & Credit Rail",
    ...
    s2_body: "I consent to JanSetu AI processing my demographic and income data (age, area, sector, income, SHG status, gender, caste) solely to match eligible Central and State government welfare schemes. Data is not sold, shared, or retained beyond the session.",
    section3: "Section 3: Bank Referral Token Authorization",
    s3_body: "I authorize JanSetu AI to issue a signed, time-limited JWT referral token (valid 15 minutes) containing my pre-verified eligibility details to a partner bank of my choice upon request. I understand I may withdraw this consent at any time before token generation.",
    ...
    grievance: "Grievance Officer: jansetu-grievance@mosje.gov.in",
    processing: "Please check all 3 consent boxes to continue.",
  },
  ta: {
    badge: "சமூக நீதி மற்றும் அதிகாரமளிப்பு அமைச்சகம் • JanSetu AI",
    title: "விதிமுறைகள், தனியுரிமை மற்றும் தரவு சம்மதம்",
    subtitle: "ஜன்சேது AI — இறையாண்மை நலத்திட்ட கண்டுபிடிப்பு மற்றும் வங்கி கடன் தளம்",
    ...
    s3_body: "என் தகுதி விவரங்களை கொண்ட கையொப்பமிடப்பட்ட, 15 நிமிட கால வரம்புள்ள JWT டோக்கனை என் விருப்பமான கூட்டாளி வங்கிக்கு வழங்க JanSetu AI-க்கு அங்கீகரிக்கிறேன்.",
    ...
    grievance: "புகார் அலுவலர்: jansetu-grievance@mosje.gov.in",
    processing: "தொடர அனைத்து 3 சம்மத பெட்டிகளையும் சரிபார்க்கவும்.",
  },
  hi: {
    badge: "सामाजिक न्याय एवं अधिकारिता मंत्रालय • JanSetu AI",
    title: "नियम, गोपनीयता और डेटा सहमति",
    subtitle: "जनसेतु AI — संप्रभु कल्याण योजना खोज एवं ऋण प्रोटोकॉल",
